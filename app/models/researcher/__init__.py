...
from app.models.researcher.researcher_extraction import ExtractionSchema, ExtractionResult
from app.models.researcher.extraction_plugins import ExtractionField, ExtractedFieldValue, ExtractionValidationResult
from app.models.researcher.plugins import Plugin, PluginConfiguration, PluginHookRegistration, PluginValidator, PluginExecutionLog, PluginRegistry

# Import other core models
from app.models.researcher.researcher_projects import ResearchProject, ProjectMember, ProjectComment, ResearchReportDraft
from app.models.researcher.researcher_documents import ResearcherDocument
from app.models.researcher.researcher_coding import Code, CodedReference, DocumentAnnotation
from app.models.researcher.researcher_chat import ChatSession, ChatMessage
from app.models.researcher.researcher_data import ResearcherDataSource, SavedChart, ScheduledReport
from app.models.researcher.researcher_training import Flashcard, Quiz, QuizQuestion, QuizAttempt
...
from app.models.researcher.phase_a_models import (
    ResearchBrief, EvidenceItem, Claim, ClaimEvidence, ReviewStep, SourceProvenance
)
from app.models.researcher.phase_b_models import RetentionPolicy, CompliancePolicyTemplate
...
__all__ = [
    'ResearchProject', 'ProjectMember', 'ProjectComment', 'ResearchReportDraft', 'ResearcherDocument', 'Code', 'CodedReference',
    'DocumentAnnotation', 'ChatSession', 'ChatMessage',
    'ResearcherDataSource', 'SavedChart', 'ScheduledReport',
    'ExtractionSchema', 'ExtractionResult', 'ExtractionField', 'ExtractedFieldValue', 'ExtractionValidationResult',
    'Plugin', 'PluginConfiguration', 'PluginHookRegistration', 'PluginValidator', 'PluginExecutionLog', 'PluginRegistry',
    'Flashcard', 'Quiz', 'QuizQuestion', 'QuizAttempt',
    'ResearchTask', 'Reference', 'DocumentReference', 'TaskNotification',
