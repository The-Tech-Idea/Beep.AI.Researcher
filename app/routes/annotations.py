...
@annotations_bp.route('/<int:project_id>/documents/<int:doc_id>/annotations', methods=['GET'])
@login_required
...
@annotations_bp.route('/<int:project_id>/documents/<int:doc_id>/annotations', methods=['POST'])
@login_required
...
@annotations_bp.route('/<int:project_id>/documents/<int:doc_id>/annotations/<int:ann_id>', methods=['DELETE'])
@login_required
