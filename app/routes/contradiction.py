            ...
            return jsonify(
                {
                    ...
                    "total_sources_checked": result.get(
                        "total_sources_checked", len(normalised)
                    ),
                    "method": "llm",
                    "message": (
                        ...
                        if normalised
                        else "No clear disagreements were found in the reviewed files."
                    ),
                }
            )
        else:
            logger.warning(
                "AI contradiction detection failed: %s — falling back to heuristic",
                result,
            )
