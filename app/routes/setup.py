...
def _wizard_defaults():
    ...
    return {
        ...
        'server_host': config_manager.get_setting('server_host', default='127.0.0.1', env_var='HOST'),
        'server_port': config_manager.get_setting('server_port', default=5005, env_var='PORT'),
    }
...
def initialize():
    ...
    try:
        ...
        if db_uri.startswith('sqlite:///') and not db_uri.startswith('sqlite:////'):
            ...
            abs_path = config_manager.base_path / rel if rel and '/' in rel else config_manager.db_path
        ...
        from app.models.researcher import (
            ResearchProject, ProjectMember, ProjectComment, ResearcherDocument,
            Code, CodedReference, DocumentAnnotation, ChatSession, ChatMessage,
            ResearcherDataSource, SavedChart, ScheduledReport,
            ExtractionSchema, ExtractionResult, Flashcard, Quiz, QuizQuestion
        )
        ...
        if not admin_role:
            ...
            admin_role.set_permissions(['researcher:view', 'researcher:contribute', 'researcher:manage', 'researcher:admin'])
